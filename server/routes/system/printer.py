...
thead = [
    ...
    {'tag': None, 'name': '프린터명', 'width': None, },
    {'tag': None, 'name': '모델명', 'width': 100, },
    {'tag': None, 'name': '연결기기명', 'width': 100, },
    {'tag': None, 'name': '통신포트', 'width': 90, },
    {'tag': None, 'name': '통신속도', 'width': 90, },
    {'tag': None, 'name': '영수증', 'width': 90, },
    {'tag': None, 'name': '고객주문서', 'width': 90, },
    {'tag': None, 'name': '주방주문서', 'width': 90, },
]
form_types = [
